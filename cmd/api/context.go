...
// Define a custome contextKey type, with the underlying type string
...
// value in the context, and if it doens't exist it will firmly be an 'unexpected' error.
// it's OK to panic in those circumtances.
