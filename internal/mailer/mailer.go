...
// Below we declare a new variable with type embed.FS (embedded file system) to hold
...
// ./templates directory in the templatesFS embedded file system variable.
...
func (m Mailer) Send(recipient, templateFile string, data interface{}) error {
	...
	// opens a connection to the SMTP server, send message, then closes the connection.
